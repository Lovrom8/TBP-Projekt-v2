...
public class RatedSongsDto
{
    ...
    public RatedSongsDto(final String songId, final String albumName, final String artist, final String genre, final String subgenres, final String albumUrl, final Integer rating)
    {
        this.songId = songId;
